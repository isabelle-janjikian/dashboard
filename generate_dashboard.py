...
<div class="app-shell">
  ...
  <div id="success-modal" class="modal-overlay" hidden>
    <div class="modal-card glass-card">
      <button type="button" class="modal-close" id="success-modal-close" aria-label="Fermer">&times;</button>
      <div class="modal-success-body">
        <span class="modal-success-icon">📨</span>
        <h2 class="modal-title">Message envoyé !</h2>
        <p class="modal-description">Votre message a bien été envoyé. Merci pour votre retour !</p>
      </div>
    </div>
  </div>
